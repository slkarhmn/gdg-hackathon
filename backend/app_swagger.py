...
assignment_input = api.model('AssignmentInput', {
    ...
    'due_date': fields.String(required=True, description='Due date (ISO format)', example='2026-02-15T23:59:59'),
    'tags': fields.List(fields.String, description='Tags'),
    'description': fields.String(description='Description'),
    'status': fields.String(description='Status (pending/in_progress/completed)', default='pending')
})
...
class AssignmentList(Resource):
    ...
    @ns_assignments.param('status', 'Filter by status')
