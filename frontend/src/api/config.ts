...
export const ENDPOINTS = {
  ...
  // AI Chat - unified endpoint for all AI textboxes
  chatMessage: (userId: number) => `${API_BASE_URL}/chat/user/${userId}/message`,
  chatSessionEnd: (userId: number) => `${API_BASE_URL}/chat/user/${userId}/session/end`,
  chatContext: (userId: number) => `${API_BASE_URL}/chat/user/${userId}/context`,
  chatContextStats: (userId: number) => `${API_BASE_URL}/chat/user/${userId}/context/stats`,
};
